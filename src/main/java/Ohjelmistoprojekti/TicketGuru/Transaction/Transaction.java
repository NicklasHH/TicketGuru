...
public class Transaction {
	...
	@NotNull
	private double amount; //voisiko/miten Ticket lähettää tämän tiedon? 
	...
	//private LocalDate transactionDate = LocalDate.now(); jos tämä käytössä, muista muuttaa myös setTransactionOk()
	//private LocalDate transactionDate;
	
	//@Column(name = "transaction_time")
	//private LocalDateTime transactionTime = LocalDateTime.now(); jos tämä käytössä, muista muuttaa myös setTransactionOk()
	...
	public void setTransactionOk(boolean transactionOk) {
		...
		//setTransactionDate(ld); //Myyntitapahtuma-aika merkitään vasta kun myyntitapahtuma ok
